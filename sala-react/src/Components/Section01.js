    ...
    <>
      <div className="box-1 container ">
        <div className="col-12 col-sm-6">
          ...
          <div className="header-text-container ">Better Business Experience</div>
          <p className="footer-text-container">At TNC Inc, we have a mission to be the world’s most respected business solutions provider. </p>
